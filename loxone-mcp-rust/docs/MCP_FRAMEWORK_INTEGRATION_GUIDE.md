...
[dependencies]
# MCP Framework
mcp-server = { path = "../mcp-framework/mcp-server" }
mcp-protocol = { path = "../mcp-framework/mcp-protocol" }
mcp-transport = { path = "../mcp-framework/mcp-transport" }
mcp-auth = { path = "../mcp-framework/mcp-auth" }
