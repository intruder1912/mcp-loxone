...
//! 
//! This creates a simple HTTP server on 127.0.0.1:8080 that mimics
...
async fn main() {
    ...
    info!("🧪 Starting Loxone Mock Server on http://127.0.0.1:8080");
    info!("   Use these credentials:");
    info!("   Username: admin");
    info!("   Password: test");
    info!("");
    info!("   Test with:");
    info!("   export LOXONE_HOST=\"127.0.0.1:8080\"");
    info!("   export LOXONE_USER=\"admin\"");
    info!("   export LOXONE_PASS=\"test\"");
