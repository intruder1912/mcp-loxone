...
impl ServerHandler for LoxoneMcpServer {
    ...
    fn get_info(&self) -> ServerInfo {
        ServerInfo {
            ...
            capabilities: ServerCapabilities::builder()
                ...
                .enable_prompts()
                .build(),
            server_info: mcp_foundation::Implementation {
    ...
    async fn call_tool(
        &self,
        request: mcp_foundation::CallToolRequestParam,
        _context: RequestContext<RoleServer>,
    ...
    async fn list_resources(
        ...
        let resources: Vec<Resource> = loxone_resources
            ...
            .map(|lr| Resource {
                ...
                annotations: Some(mcp_foundation::Annotations::default()),
                raw: Some(mcp_foundation::RawResource {
                    uri: lr.uri.clone(),
    ...
    async fn initialize(
        ...
        _context: RequestContext<RoleServer>,
    ) -> Result<mcp_foundation::InitializeResult, Error> {
        debug!("MCP Server initialize request received");
        Ok(mcp_foundation::InitializeResult {
            protocol_version: mcp_foundation::ProtocolVersion::default().to_string(),
            capabilities: mcp_foundation::ServerCapabilities::builder()
                .enable_tools()
                .enable_resources()
                .enable_prompts()
                .build(),
    ...
    async fn complete(
        ...
        _context: RequestContext<RoleServer>,
    ) -> Result<mcp_foundation::CompleteResult, Error> {
        debug!("Completion request received");
        // Return empty completion result (no completions supported yet)
        Ok(mcp_foundation::CompleteResult {
            completion: vec![mcp_foundation::CompletionInfo {
    ...
    async fn list_resource_templates(
        ...
        _request: mcp_foundation::PaginatedRequestParam,
        _context: RequestContext<RoleServer>,
    ) -> Result<mcp_foundation::ListResourceTemplatesResult, Error> {
    ...
    async fn subscribe(
        &self,
        request: mcp_foundation::SubscribeRequestParam,
    ...
    async fn unsubscribe(
        &self,
        request: mcp_foundation::UnsubscribeRequestParam,
        context: RequestContext<RoleServer>,
    ) -> Result<(), Error> {
...
impl LoxoneMcpServer {
    ...
    pub async fn get_cozy_prompt_messages(
    ...
    ) -> Result<Vec<mcp_foundation::PromptMessage>, crate::error::LoxoneError> {
        ...
        let context_message = mcp_foundation::PromptMessage::new_text(
            mcp_foundation::PromptMessageRole::User,
            format!(
        ...
        if let Some(ref sampling_integration) = self.sampling_integration {
                ...
                .await
            {
                Ok(sampling_response) => {
                    ...
                    let assistant_message = mcp_foundation::PromptMessage::new_text(
                        mcp_foundation::PromptMessageRole::Assistant,
                        response_text,
                    );
