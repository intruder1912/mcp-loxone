...
use crate::logging::sanitization::get_sanitizer;
...
impl ErrorClass {
    /// Classify a Loxone error
    pub fn from_loxone_error(error: &crate::error::LoxoneError) -> Self {
        match error {
            crate::error::LoxoneError::Connection(_) => Self::Network {
                error_type: "connection_failed".to_string(),
                timeout: false,
            },
            crate::error::LoxoneError::Timeout(_) => Self::Network {
                error_type: "timeout".to_string(),
                timeout: true,
            },
            crate::error::LoxoneError::Authentication(_) => Self::Auth {
                error_type: "authentication_failed".to_string(),
            },
            crate::error::LoxoneError::InvalidInput(_) => Self::Client {
                error_type: "invalid_input".to_string(),
                retryable: false,
            },
            crate::error::LoxoneError::DeviceControl(_) => Self::Business {
                error_type: "device_control_failed".to_string(),
                domain: "loxone".to_string(),
            },
            crate::error::LoxoneError::Config(_) => Self::Server {
                error_type: "configuration_error".to_string(),
                retryable: false,
            },
            crate::error::LoxoneError::Credentials(_) => Self::Server {
                error_type: "credentials_error".to_string(),
                retryable: false,
            },
            _ => Self::Server {
...
impl StructuredLogger {
    ...
    pub fn log_request_end(
        ...
        let error_class = error.map(ErrorClass::from_loxone_error);
...
mod tests {
    ...
    fn test_error_classification() {
        let auth_error = crate::error::LoxoneError::authentication("Auth failed");
        let error_class = ErrorClass::from_loxone_error(&auth_error);
