...
impl MetricsCollector {
    ...
    pub async fn get_current_metrics(&self) -> ServerMetrics {
        ...
        ServerMetrics {
            requests_total,
            requests_per_second: if uptime_seconds > 0 { requests_total as f64 / uptime_seconds as f64 } else { 0.0 },
            average_response_time_ms: 0.0, // TODO: Implement response time tracking
            error_rate: if requests_total > 0 { errors_total as f64 / requests_total as f64 } else { 0.0 },
