...
use loxone_mcp_rust::client::command_queue::{
    CommandPriority, CommandQueue, CommandQueueConfig, ExecutionStrategy, QueuedCommand,
};
...
async fn test_critical_command() {
    let command = QueuedCommand::new_critical(
        "device1".to_string(),
        "alarm".to_string(),
        "test".to_string(),
    );
...
async fn test_command_retry_logic() {
    let mut command = QueuedCommand::new(
        "device1".to_string(),
        "test".to_string(),
        "test".to_string(),
    )
...
async fn test_queue_size_limit() {
    ...
    let cmd1 = QueuedCommand::new(
        "device1".to_string(),
        "cmd1".to_string(),
        "test".to_string(),
    );
    let cmd2 = QueuedCommand::new(
        "device2".to_string(),
        "cmd2".to_string(),
        "test".to_string(),
    );
    let cmd3 = QueuedCommand::new(
        "device3".to_string(),
        "cmd3".to_string(),
        "test".to_string(),
    );
...
async fn test_command_expiration() {
    ...
    let expired_command = QueuedCommand::new(
        "device1".to_string(),
        "test".to_string(),
        "test".to_string(),
    )
...
async fn test_commands_by_priority() {
    ...
    let cmd1 = QueuedCommand::new_high_priority(
        "device1".to_string(),
        "cmd1".to_string(),
        "test".to_string(),
    );
    let cmd2 = QueuedCommand::new_high_priority(
        "device2".to_string(),
        "cmd2".to_string(),
        "test".to_string(),
    );
    ...
    let normal_priority_commands = queue
        .get_commands_by_priority(CommandPriority::Normal)
        .await;
...
async fn test_batch_execution_with_failures() {
    ...
    // Add commands
    let success_cmd = QueuedCommand::new(
        "device1".to_string(),
        "success".to_string(),
        "test".to_string(),
    );
    let fail_cmd = QueuedCommand::new(
        "device2".to_string(),
        "fail".to_string(),
        "test".to_string(),
    );
...
async fn test_expired_command_handling() {
    ...
    let mut expired_command = QueuedCommand::new(
        "device1".to_string(),
        "test".to_string(),
        "test".to_string(),
    );
