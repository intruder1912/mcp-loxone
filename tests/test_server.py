...
class TestRoomManagement:
    ...
    @pytest.mark.asyncio
    async def test_list_rooms(self, mock_context, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_list_rooms_no_context(self, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_get_room_devices(self, mock_context, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_get_room_devices_with_type_filter(self, mock_context, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_get_room_devices_partial_match(self, mock_context, monkeypatch):
    ...
    @pytest.mark.asyncio 
    async def test_get_room_devices_no_match(self, mock_context, monkeypatch):
